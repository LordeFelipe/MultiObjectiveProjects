...
int main(int argc, char **argv) {
  ...
  FILE* fp = fopen("CREProblems/CRE31/pop_vars_eval.txt","r");
  FILE* out = fopen("CREProblems/CRE31/pop_vars_obj.txt","w");
  FILE* cons = fopen("CREProblems/CRE31/pop_vars_cons.txt","w");
